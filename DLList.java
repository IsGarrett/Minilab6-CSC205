...
Description: The purpose of this code is to implement a Doubly Linked List as its own unique data structure. The code provides different method functionality such as adding values, removing values, 
checking for specific values and other various methods to use within this data structure class.
*/
